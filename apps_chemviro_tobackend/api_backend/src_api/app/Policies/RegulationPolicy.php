...
class RegulationPolicy
{
    ...
    {
        return $user->can('view_any_regulation');
    }
    ...
    {
        return $user->can('view_regulation');
    }
    ...
    {
        return $user->can('create_regulation');
    }
    ...
    {
        return $user->can('update_regulation');
    }
    ...
    {
        return $user->can('delete_regulation');
    }
    ...
    {
        return $user->can('delete_any_regulation');
    }
     ...
     */
    public function replicate(User $user, Regulation $regulation): bool
    {
